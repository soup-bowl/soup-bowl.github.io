	...
	return (
		<ProfileDisplay>
			...
			<div className="description">
				...
				<p>
					My primary languages are <strong>C#</strong> and <strong>TypeScript</strong>, with experience in similar
					languages too. I have several years of experience with <strong>Git</strong> and Git technology platforms,
					primarily{" "} <strong>Azure DevOps</strong>, <strong>GitHub</strong> and <strong>GitLab</strong>, and some
