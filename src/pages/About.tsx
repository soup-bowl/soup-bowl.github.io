	...
	return (
		<ProfileDisplay>
			...
			<div className="description">
				...
				<p>
					If you wish to see more about me, please <a href="https://blog.soupbowl.io" style={{ fontWeight: 'bold' }}>check out my blog</a> or <a href="mailto:code@soupbowl.io" style={{ fontWeight: 'bold' }}>contact me</a>.
				</p>
